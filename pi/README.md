...
*Flock Noir 0.4.2 for **Pi Zero 2 W + Camera Module NoIR v2**, sharing the XIAO
...
2. Choose the **Pi 0.4.2** release and verify its checksum.
...
|---|---|---|
| Camera | OV2640; VGA capture/analysis about 25 fps on 0.4.2; preview is slower | NoIR; configured for 60 fps, hardware rate must be measured |
...
Version 0.4.2 surfaces radio-only detections on the Detector tab, includes the
